...
use CTIC\Customer\Customer\Domain\Validation\CustomerGroupValidation;

/**
 * @ORM\Entity(repositoryClass="CTIC\Customer\Customer\Infrastructure\Repository\CustomerGroupRepository")
 */
class CustomerGroup implements CustomerGroupInterface
{
    use IdentifiableTrait;
    use CustomerGroupValidation;
