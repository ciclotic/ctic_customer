...
use CTIC\Customer\Customer\Infrastructure\Controller\CustomerController;
use CTIC\Customer\Customer\Infrastructure\Form\Type\CustomerType;
...
class CreateCustomerController extends CreateResourceController
{
    /**
    ...
    ): void
    {
        ...
        $formRegistry->addType(new CustomerType(Customer::class));
    }
        ...
        if(empty($command->metadata))
        {
            $command->metadata = self::getMetadata(
                ...
                array(
                    ...
                    'classes'       => array(
                        'form'      => 'CTIC\Customer\Customer\Infrastructure\Form\Type\CustomerType'
                    ),
                    'grid'          => array(
                        'actionGroups'  => array(
                            'bulk'  => array(
    ...
    public static function setDefaultCommand(ResourceControllerCommand $command): void
    {
        if(empty($command->newResourceFactory))
        {
            $command->newResourceFactory = new CreateCustomer();
        }
        if(empty($command->resource))
        {
            $command->resource = Customer::class;
        }
        if(empty($command->command))
        {
